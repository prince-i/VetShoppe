<?php
	...
	$flaton_home = array(
    	...
    	'service-icon-1' => 'fas fa-bullhorn',
        ...
        'service-icon-4' => 'fas fa-layer-group',
        'service-title-4' => __('Design', 'flaton'),
        'service-description-4' => 'html',
        'service-icon-5' => 'fab fa-digg',
        ...
        'percentage-1' => '80',
        'skill-icon-1' => 'fas fa-bell',
        'skill-2' => __('Management','flaton'),
        'percentage-2' => '60',
        'skill-icon-2' => 'fas fa-camera',
        'skill-3' => __('Design','flaton'),
        'percentage-3' => '90',
        'skill-icon-3' => 'fas fa-recycle',
        'skill-4' => __('HTML &amp; CSS','flaton'),
        'percentage-4' => '100',
        'skill-icon-4' => 'fas fa-user',
        'skill-5' => __('WordPress','flaton'),
        'percentage-5' => '80',
        'skill-icon-5' => 'fab fa-wordpress',
